...
>
  ...
  <@fdsSlideOutPanel.slideOutPanelButton buttonText="Complete QA checks" buttonPanelId="Qa-Panel"/>
  <@fdsSlideOutPanel.slideOutPanelButton buttonText="Request further information" buttonPanelId="Info-Request-Panel"/>
