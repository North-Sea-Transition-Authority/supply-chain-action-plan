...
import {PathfinderProjectsPage} from "./page-objects/pathfinderProjects.page.ts";
...
describe('Submit and update Related Pathfinder Projects SCAP', () => {
    ...
    it('should successfully update the Related Pathfinder Projects SCAP', async () =>{
        ...
        await pathfinderProjectsPage.yesPathfinderProjectPage();
    ...
    it('should succesfully approve the Related Pathfinder Projects SCAP', async () =>{
